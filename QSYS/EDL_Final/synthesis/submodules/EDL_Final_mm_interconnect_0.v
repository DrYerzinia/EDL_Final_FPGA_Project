...
module EDL_Final_mm_interconnect_0 (
	...
	wire    [2:0] rsp_mux_src_channel;                                                       // rsp_mux:src_channel -> cpu_data_master_agent:rp_channel
	...
	wire    [2:0] rsp_mux_001_src_channel;                                                   // rsp_mux_001:src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire  [101:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire  [101:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire   [83:0] sdram_s1_agent_rp_data;                                                    // sdram_s1_agent:rp_data -> router_004:sink_data
	...
	wire   [83:0] router_004_src_data;                                                       // router_004:src_data -> sdram_s1_rsp_width_adapter:in_data
	...
	wire  [101:0] sdram_s1_rsp_width_adapter_src_data;                                       // sdram_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          sdram_s1_rsp_width_adapter_src_ready;                                      // rsp_demux_002:sink_ready -> sdram_s1_rsp_width_adapter:out_ready
	wire    [2:0] sdram_s1_rsp_width_adapter_src_channel;                                    // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire  [101:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> sdram_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                     // sdram_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> sdram_s1_cmd_width_adapter:in_channel
