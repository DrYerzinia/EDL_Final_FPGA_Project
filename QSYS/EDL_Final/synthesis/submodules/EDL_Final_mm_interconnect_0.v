...
module EDL_Final_mm_interconnect_0 (
		...
		output wire [1:0]  camera_1_s1_address,                     //                     camera_1_s1.address
		input  wire [31:0] camera_1_s1_readdata,                    //                                .readdata
	...
	wire  [103:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                     // button_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [5:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> button_s1_agent:cp_channel
	...
	wire   [31:0] camera_1_s1_agent_m0_readdata;                                             // camera_1_s1_translator:uav_readdata -> camera_1_s1_agent:m0_readdata
	wire          camera_1_s1_agent_m0_waitrequest;                                          // camera_1_s1_translator:uav_waitrequest -> camera_1_s1_agent:m0_waitrequest
	wire          camera_1_s1_agent_m0_debugaccess;                                          // camera_1_s1_agent:m0_debugaccess -> camera_1_s1_translator:uav_debugaccess
	wire   [27:0] camera_1_s1_agent_m0_address;                                              // camera_1_s1_agent:m0_address -> camera_1_s1_translator:uav_address
	wire    [3:0] camera_1_s1_agent_m0_byteenable;                                           // camera_1_s1_agent:m0_byteenable -> camera_1_s1_translator:uav_byteenable
	wire          camera_1_s1_agent_m0_read;                                                 // camera_1_s1_agent:m0_read -> camera_1_s1_translator:uav_read
	wire          camera_1_s1_agent_m0_readdatavalid;                                        // camera_1_s1_translator:uav_readdatavalid -> camera_1_s1_agent:m0_readdatavalid
	wire          camera_1_s1_agent_m0_lock;                                                 // camera_1_s1_agent:m0_lock -> camera_1_s1_translator:uav_lock
	wire   [31:0] camera_1_s1_agent_m0_writedata;                                            // camera_1_s1_agent:m0_writedata -> camera_1_s1_translator:uav_writedata
	wire          camera_1_s1_agent_m0_write;                                                // camera_1_s1_agent:m0_write -> camera_1_s1_translator:uav_write
	wire    [2:0] camera_1_s1_agent_m0_burstcount;                                           // camera_1_s1_agent:m0_burstcount -> camera_1_s1_translator:uav_burstcount
	wire          camera_1_s1_agent_rf_source_valid;                                         // camera_1_s1_agent:rf_source_valid -> camera_1_s1_agent_rsp_fifo:in_valid
	wire  [104:0] camera_1_s1_agent_rf_source_data;                                          // camera_1_s1_agent:rf_source_data -> camera_1_s1_agent_rsp_fifo:in_data
	wire          camera_1_s1_agent_rf_source_ready;                                         // camera_1_s1_agent_rsp_fifo:in_ready -> camera_1_s1_agent:rf_source_ready
	wire          camera_1_s1_agent_rf_source_startofpacket;                                 // camera_1_s1_agent:rf_source_startofpacket -> camera_1_s1_agent_rsp_fifo:in_startofpacket
	wire          camera_1_s1_agent_rf_source_endofpacket;                                   // camera_1_s1_agent:rf_source_endofpacket -> camera_1_s1_agent_rsp_fifo:in_endofpacket
	wire          camera_1_s1_agent_rsp_fifo_out_valid;                                      // camera_1_s1_agent_rsp_fifo:out_valid -> camera_1_s1_agent:rf_sink_valid
	wire  [104:0] camera_1_s1_agent_rsp_fifo_out_data;                                       // camera_1_s1_agent_rsp_fifo:out_data -> camera_1_s1_agent:rf_sink_data
	wire          camera_1_s1_agent_rsp_fifo_out_ready;                                      // camera_1_s1_agent:rf_sink_ready -> camera_1_s1_agent_rsp_fifo:out_ready
	wire          camera_1_s1_agent_rsp_fifo_out_startofpacket;                              // camera_1_s1_agent_rsp_fifo:out_startofpacket -> camera_1_s1_agent:rf_sink_startofpacket
	wire          camera_1_s1_agent_rsp_fifo_out_endofpacket;                                // camera_1_s1_agent_rsp_fifo:out_endofpacket -> camera_1_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                     // cmd_mux_005:src_valid -> camera_1_s1_agent:cp_valid
	wire  [103:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> camera_1_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                     // camera_1_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [5:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> camera_1_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                             // cmd_mux_005:src_startofpacket -> camera_1_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                               // cmd_mux_005:src_endofpacket -> camera_1_s1_agent:cp_endofpacket
	...
	wire  [103:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_005:sink_data
	...
	wire          camera_1_s1_agent_rp_valid;                                                // camera_1_s1_agent:rp_valid -> router_007:sink_valid
	wire  [103:0] camera_1_s1_agent_rp_data;                                                 // camera_1_s1_agent:rp_data -> router_007:sink_data
	wire          camera_1_s1_agent_rp_ready;                                                // router_007:sink_ready -> camera_1_s1_agent:rp_ready
	wire          camera_1_s1_agent_rp_startofpacket;                                        // camera_1_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          camera_1_s1_agent_rp_endofpacket;                                          // camera_1_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          camera_1_s1_agent_rdata_fifo_src_valid;                                    // camera_1_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] camera_1_s1_agent_rdata_fifo_src_data;                                     // camera_1_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          camera_1_s1_agent_rdata_fifo_src_ready;                                    // avalon_st_adapter_005:in_0_ready -> camera_1_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                         // avalon_st_adapter_005:out_0_valid -> camera_1_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                          // avalon_st_adapter_005:out_0_data -> camera_1_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                         // camera_1_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                         // avalon_st_adapter_005:out_0_error -> camera_1_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) camera_1_s1_translator (
		.clk                    (clk_sys_clk_clk),                       //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (camera_1_s1_agent_m0_address),          // avalon_universal_slave_0.address
		.uav_burstcount         (camera_1_s1_agent_m0_burstcount),       //                         .burstcount
		.uav_read               (camera_1_s1_agent_m0_read),             //                         .read
		.uav_write              (camera_1_s1_agent_m0_write),            //                         .write
		.uav_waitrequest        (camera_1_s1_agent_m0_waitrequest),      //                         .waitrequest
		.uav_readdatavalid      (camera_1_s1_agent_m0_readdatavalid),    //                         .readdatavalid
		.uav_byteenable         (camera_1_s1_agent_m0_byteenable),       //                         .byteenable
		.uav_readdata           (camera_1_s1_agent_m0_readdata),         //                         .readdata
		.uav_writedata          (camera_1_s1_agent_m0_writedata),        //                         .writedata
		.uav_lock               (camera_1_s1_agent_m0_lock),             //                         .lock
		.uav_debugaccess        (camera_1_s1_agent_m0_debugaccess),      //                         .debugaccess
		.av_address             (camera_1_s1_address),                   //      avalon_anti_slave_0.address
		.av_readdata            (camera_1_s1_readdata),                  //                         .readdata
		.av_write               (),                                      //              (terminated)
		.av_read                (),                                      //              (terminated)
		.av_writedata           (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_sys_clk_clk),                              //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),        //       clk_reset.reset
		.m0_address              (camera_1_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (camera_1_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (camera_1_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (camera_1_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (camera_1_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (camera_1_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (camera_1_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (camera_1_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (camera_1_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (camera_1_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (camera_1_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (camera_1_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (camera_1_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (camera_1_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (camera_1_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (camera_1_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (camera_1_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (camera_1_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (camera_1_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (camera_1_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (camera_1_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (camera_1_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (camera_1_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (camera_1_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (camera_1_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (camera_1_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),            // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),            //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),             //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),            //                .error
		.rdata_fifo_src_ready    (camera_1_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (camera_1_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (camera_1_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                        //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                          //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) camera_1_s1_agent_rsp_fifo (
		.clk               (clk_sys_clk_clk),                              //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
		.in_data           (camera_1_s1_agent_rf_source_data),             //        in.data
		.in_valid          (camera_1_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (camera_1_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (camera_1_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (camera_1_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (camera_1_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (camera_1_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (camera_1_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (camera_1_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (camera_1_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                        // (terminated)
		.csr_read          (1'b0),                                         // (terminated)
		.csr_write         (1'b0),                                         // (terminated)
		.csr_readdata      (),                                             // (terminated)
	...
	EDL_Final_mm_interconnect_0_router_002 router_005 (
	...
	EDL_Final_mm_interconnect_0_router_002 router_006 (
	...
	EDL_Final_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (camera_1_s1_agent_rp_ready),            //      sink.ready
		.sink_valid         (camera_1_s1_agent_rp_valid),            //          .valid
		.sink_data          (camera_1_s1_agent_rp_data),             //          .data
		.sink_startofpacket (camera_1_s1_agent_rp_startofpacket),    //          .startofpacket
		.sink_endofpacket   (camera_1_s1_agent_rp_endofpacket),      //          .endofpacket
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_sys_clk_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_sys_clk_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_sys_clk_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_demux_001 rsp_demux_001 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_sys_clk_clk),                              //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),        // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
	...
	EDL_Final_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_sys_clk_clk),                        // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset),  // in_rst_0.reset
		.in_0_data      (camera_1_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (camera_1_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (camera_1_s1_agent_rdata_fifo_src_ready), //         .ready
