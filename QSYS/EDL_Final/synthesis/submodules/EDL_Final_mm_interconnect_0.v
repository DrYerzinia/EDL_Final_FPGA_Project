...
module EDL_Final_mm_interconnect_0 (
	...
	wire    [5:0] rsp_mux_002_src_channel;                                                                   // rsp_mux_002:src_channel -> cpu_instruction_master_agent:rp_channel
	...
	wire    [5:0] cmd_mux_002_src_channel;                                                                   // cmd_mux_002:src_channel -> video_dma_controller_avalon_dma_control_slave_agent:cp_channel
	...
	wire    [5:0] router_003_src_channel;                                                                    // router_003:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [5:0] sdram_s1_rsp_width_adapter_src_channel;                                                    // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire    [5:0] cmd_mux_src_channel;                                                                       // cmd_mux:src_channel -> sdram_s1_cmd_width_adapter:in_channel
