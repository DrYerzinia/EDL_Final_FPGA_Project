...
module EDL_Final_mm_interconnect_0 (
	...
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> button_s1_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> button_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // button_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [5:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> button_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> button_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> button_s1_agent:cp_endofpacket
	...
	wire  [103:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [103:0] button_s1_agent_rp_data;                                                   // button_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [103:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_006:sink_data
	...
	EDL_Final_mm_interconnect_0_router_002 router_004 (
	...
	EDL_Final_mm_interconnect_0_router_003 router_006 (
	...
	EDL_Final_mm_interconnect_0_router_007 router_007 (
	...
	EDL_Final_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_sys_clk_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_mux_001 cmd_mux_004 (
		.clk                 (clk_sys_clk_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_cmd_demux_001 rsp_demux_004 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_0_avalon_st_adapter_005 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
