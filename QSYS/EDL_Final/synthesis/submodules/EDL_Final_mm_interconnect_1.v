...
module EDL_Final_mm_interconnect_1 (
		...
		input  wire        pixel_clk_out_clk_clk,                         //                     pixel_clk_out_clk.clk
	...
	wire   [27:0] video_dma_avalon_dma_control_slave_agent_m0_address;                       // video_dma_avalon_dma_control_slave_agent:m0_address -> video_dma_avalon_dma_control_slave_translator:uav_address
	...
	wire  [104:0] video_dma_avalon_dma_control_slave_agent_rf_source_data;                   // video_dma_avalon_dma_control_slave_agent:rf_source_data -> video_dma_avalon_dma_control_slave_agent_rsp_fifo:in_data
	...
	wire  [104:0] video_dma_avalon_dma_control_slave_agent_rsp_fifo_out_data;                // video_dma_avalon_dma_control_slave_agent_rsp_fifo:out_data -> video_dma_avalon_dma_control_slave_agent:rf_sink_data
	...
	wire          video_dma_avalon_dma_control_slave_agent_rdata_fifo_src_valid;             // video_dma_avalon_dma_control_slave_agent:rdata_fifo_src_valid -> video_dma_avalon_dma_control_slave_agent_rdata_fifo:in_valid
	wire   [33:0] video_dma_avalon_dma_control_slave_agent_rdata_fifo_src_data;              // video_dma_avalon_dma_control_slave_agent:rdata_fifo_src_data -> video_dma_avalon_dma_control_slave_agent_rdata_fifo:in_data
	wire          video_dma_avalon_dma_control_slave_agent_rdata_fifo_src_ready;             // video_dma_avalon_dma_control_slave_agent_rdata_fifo:in_ready -> video_dma_avalon_dma_control_slave_agent:rdata_fifo_src_ready
	wire          cmd_mux_src_valid;                                                         // cmd_mux:src_valid -> video_dma_avalon_dma_control_slave_agent:cp_valid
	wire  [103:0] cmd_mux_src_data;                                                          // cmd_mux:src_data -> video_dma_avalon_dma_control_slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                         // video_dma_avalon_dma_control_slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [5:0] cmd_mux_src_channel;                                                       // cmd_mux:src_channel -> video_dma_avalon_dma_control_slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                 // cmd_mux:src_startofpacket -> video_dma_avalon_dma_control_slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                   // cmd_mux:src_endofpacket -> video_dma_avalon_dma_control_slave_agent:cp_endofpacket
	...
	wire          video_dma_avalon_dma_control_slave_agent_rp_valid;                         // video_dma_avalon_dma_control_slave_agent:rp_valid -> router_002:sink_valid
	wire  [103:0] video_dma_avalon_dma_control_slave_agent_rp_data;                          // video_dma_avalon_dma_control_slave_agent:rp_data -> router_002:sink_data
	wire          video_dma_avalon_dma_control_slave_agent_rp_ready;                         // router_002:sink_ready -> video_dma_avalon_dma_control_slave_agent:rp_ready
	wire          video_dma_avalon_dma_control_slave_agent_rp_startofpacket;                 // video_dma_avalon_dma_control_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          video_dma_avalon_dma_control_slave_agent_rp_endofpacket;                   // video_dma_avalon_dma_control_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire    [5:0] rsp_demux_src0_channel;                                                    // rsp_demux:src0_channel -> crosser_001:in_channel
	...
	wire    [5:0] crosser_001_out_channel;                                                   // crosser_001:out_channel -> rsp_mux:sink0_channel
	...
	wire          video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_valid;             // video_dma_avalon_dma_control_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_data;              // video_dma_avalon_dma_control_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_ready;             // avalon_st_adapter:in_0_ready -> video_dma_avalon_dma_control_slave_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_out_0_valid;                                             // avalon_st_adapter:out_0_valid -> video_dma_avalon_dma_control_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                              // avalon_st_adapter:out_0_data -> video_dma_avalon_dma_control_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                             // video_dma_avalon_dma_control_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                             // avalon_st_adapter:out_0_error -> video_dma_avalon_dma_control_slave_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (pixel_clk_out_clk_clk),                                     //                      clk.clk
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) video_dma_avalon_dma_control_slave_agent_rdata_fifo (
		.clk               (pixel_clk_out_clk_clk),                                         //       clk.clk
		.reset             (video_dma_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.in_data           (video_dma_avalon_dma_control_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (video_dma_avalon_dma_control_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (video_dma_avalon_dma_control_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                         // (terminated)
		.csr_read          (1'b0),                                                          // (terminated)
		.csr_write         (1'b0),                                                          // (terminated)
		.csr_readdata      (),                                                              // (terminated)
	...
	EDL_Final_mm_interconnect_1_router_004 router_007 (
	...
	EDL_Final_mm_interconnect_1_cmd_mux_002 cmd_mux_005 (
		.clk                 (clk_sys_clk_clk),                       //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_1_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_1_rsp_demux_001 rsp_demux_003 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_1_rsp_demux_001 rsp_demux_004 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	EDL_Final_mm_interconnect_1_cmd_demux_001 rsp_demux_005 (
		.clk                (clk_sys_clk_clk),                       //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_clk           (pixel_clk_out_clk_clk),                       //       out_clk.clk
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_clk            (pixel_clk_out_clk_clk),                       //        in_clk.clk
	...
	EDL_Final_mm_interconnect_1_avalon_st_adapter #(
		...
		.in_clk_0_clk   (pixel_clk_out_clk_clk),                                         // in_clk_0.clk
		.in_rst_0_reset (video_dma_reset_reset_bridge_in_reset_reset),                   // in_rst_0.reset
		.in_0_data      (video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (video_dma_avalon_dma_control_slave_agent_rdata_fifo_out_ready), //         .ready
